...
- **Single-cell Seq** - Worked alongside my master's project and performed pre-processing, till gene expression.
- **Single-Nucleus Seq** - Created workflow to identify somatic mutations from single-nucleus MS brain dataset.

## My Tech Stack
Languages: `R` `Python` `Bash`\
Workflow Management: `Snakemake`\
Version Control: `Git`\
Containerization & Package Management: `Conda` `Bioconda`
